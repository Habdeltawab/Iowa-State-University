...
/**
 * Example of evaluating expression trees using a postorder traversal.
 * The method makeFromPostfix() illustrates building up a tree using 
 * a stack of subtrees.
 */
public class ExpressionTree
{
   ...
   * @param node root of the subtree to evaluate
  ...
  /**
   * Creates an expression tree from an arithmetic expression in
   * postfix form. Note the format of the expression is highly restricted,
   * numbers can only be one digit long and can't be negative.
   * @param expr
   * @return
   */
