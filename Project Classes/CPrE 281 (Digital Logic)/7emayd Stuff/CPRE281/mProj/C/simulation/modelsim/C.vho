...
-- C	=>  Location: PIN_C11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- y	=>  Location: PIN_B11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- w	=>  Location: PIN_B12,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
-- Equation(s):
-- \C~0_combout\ = (\z~combout\ & ((\y~combout\ & ((\x~combout\))) # (!\y~combout\ & (!\w~combout\))))
