...
ARCHITECTURE structure OF Bob IS
...
-- Equation(s):
-- \f~0_combout\ = (\z~combout\ & ((\y~combout\ & ((\w~combout\))) # (!\y~combout\ & (\x~combout\)))) # (!\z~combout\ & (!\x~combout\ & (\y~combout\ & !\w~combout\)))
