...
-- w[0]	=>  Location: PIN_V1,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- w[1]	=>  Location: PIN_V2,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
-- Equation(s):
-- \inst~combout\ = (!\w~combout\(0) & (!\w~combout\(1) & \Enable~combout\))
...
-- Equation(s):
-- \inst6~combout\ = (\w~combout\(0) & (!\w~combout\(1) & \Enable~combout\))
...
-- Equation(s):
-- \inst7~combout\ = (!\w~combout\(0) & (\w~combout\(1) & \Enable~combout\))
...
-- Equation(s):
-- \inst8~combout\ = (\w~combout\(0) & (\w~combout\(1) & \Enable~combout\))
