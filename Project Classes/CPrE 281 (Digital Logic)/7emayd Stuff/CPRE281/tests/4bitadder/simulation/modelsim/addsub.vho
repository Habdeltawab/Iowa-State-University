...
-- Equation(s):
-- \inst|inst1|Cout~0_combout\ = (\Y~combout\(1) & ((\X~combout\(1)) # ((\X~combout\(0) & \Y~combout\(0))))) # (!\Y~combout\(1) & (\X~combout\(0) & (\X~combout\(1) & \Y~combout\(0))))
...
-- Equation(s):
-- \inst|inst3|S~0_combout\ = \X~combout\(3) $ (((\Y~combout\(2) & ((\X~combout\(2)) # (\inst|inst1|Cout~0_combout\))) # (!\Y~combout\(2) & (\X~combout\(2) & \inst|inst1|Cout~0_combout\))))
...
-- Equation(s):
-- \inst|inst1|S~0_combout\ = \Y~combout\(1) $ (\X~combout\(1) $ (((\X~combout\(0) & \Y~combout\(0)))))
