...
ARCHITECTURE structure OF \2x1BusMUX\ IS
...
-- Equation(s):
-- \inst4|inst2~0_combout\ = (\S~combout\ & ((\B~combout\(3)))) # (!\S~combout\ & (\A~combout\(3)))
...
\inst3|inst2~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst3|inst2~0_combout\ = (\S~combout\ & ((\B~combout\(2)))) # (!\S~combout\ & (\A~combout\(2)))
...
-- Equation(s):
-- \inst|inst2~0_combout\ = (\S~combout\ & ((\B~combout\(1)))) # (!\S~combout\ & (\A~combout\(1)))
...
\inst5|inst2~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst5|inst2~0_combout\ = (\S~combout\ & (\B~combout\(0))) # (!\S~combout\ & ((\A~combout\(0))))
