...
ARCHITECTURE structure OF negative IS
...
-- Equation(s):
-- \inst|inst~1_combout\ = (GLOBAL(\Clk~clkctrl_outclk\) & ((!\D~combout\))) # (!GLOBAL(\Clk~clkctrl_outclk\) & (\inst|inst~1_combout\))
...
-- Equation(s):
-- \inst1|inst~1_combout\ = (GLOBAL(\Clk~clkctrl_outclk\) & (\inst1|inst~1_combout\)) # (!GLOBAL(\Clk~clkctrl_outclk\) & ((\inst|inst~1_combout\)))
