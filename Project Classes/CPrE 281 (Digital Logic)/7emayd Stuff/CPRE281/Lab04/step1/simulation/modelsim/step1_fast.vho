...
-- Farmer	=>  Location: PIN_AE14,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
-- Equation(s):
-- \WideOr0~0_combout\ = (\Goat~combout\ & (!\Farmer~combout\ & ((\Wolf~combout\) # (\Cabbage~combout\)))) # (!\Goat~combout\ & (\Farmer~combout\ & ((!\Cabbage~combout\) # (!\Wolf~combout\))))
