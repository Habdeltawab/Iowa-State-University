...
-- AC	=>  Location: PIN_Y18,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- Equation(s):
-- \inst2|WideOr0~0_combout\ = (\M~combout\ & (((!\T~combout\) # (!\P~combout\)) # (!\H~combout\))) # (!\M~combout\ & ((\H~combout\ & (!\P~combout\ & !\T~combout\)) # (!\H~combout\ & ((!\T~combout\) # (!\P~combout\)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0010101110111111",
