...
SIGNAL \kjrtg~0_combout\ : std_logic;
...
\kjrtg~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \kjrtg~0_combout\ = (\G~combout\ & ((\W~combout\) # (\C~combout\))) # (!\G~combout\ & ((!\C~combout\) # (!\W~combout\)))
