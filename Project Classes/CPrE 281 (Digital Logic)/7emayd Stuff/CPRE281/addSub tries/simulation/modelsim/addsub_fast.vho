...
-- w2	=>  Location: PIN_V2,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- Clk	=>  Location: PIN_AC13,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- clear	=>  Location: PIN_U4,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
-- Equation(s):
-- \inst783~1_combout\ = (\inst783~0_combout\ & (((\w1~combout\)) # (!\w2~combout\))) # (!\inst783~0_combout\ & (\inst255~regout\ & ((\w2~combout\) # (\w1~combout\))))
