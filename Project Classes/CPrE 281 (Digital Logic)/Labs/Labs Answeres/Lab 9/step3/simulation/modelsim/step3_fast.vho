...
-- Equation(s):
-- \inst|inst3~1_combout\ = (GLOBAL(\clk~clkctrl_outclk\) & ((!\D~combout\))) # (!GLOBAL(\clk~clkctrl_outclk\) & (\inst|inst3~1_combout\))
...
-- Equation(s):
-- \inst1|inst3~1_combout\ = (GLOBAL(\clk~clkctrl_outclk\) & (\inst1|inst3~1_combout\)) # (!GLOBAL(\clk~clkctrl_outclk\) & ((\inst|inst3~1_combout\)))
